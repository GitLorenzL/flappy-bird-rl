...
parser.add_argument(
    "--memory_size", type=int, help="memory size for experience replay", default=5000
)
parser.add_argument(
    "--init_e",
    type=float,
...
parser.add_argument(
    "--max_episode", type=int, help="maximum episode of training", default=20000
)
parser.add_argument(
    "--weight", type=str, help="weight file name for finetunig(Optional)", default=""
)
parser.add_argument(
